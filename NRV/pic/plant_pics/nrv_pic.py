...
df_new_single_row = pd.read_excel("../nrv_analysis.xlsx")

for i in range(len(df_new_single_row)):
# for i in range(10):
    ...
    new_single_row_df.columns = ["Nutrient", "Value of 100g", "NRV%"]
    ...
    plt.savefig(str(new_single_row["Food code"])+str(new_single_row["Food name"])+"营养标签"+'.png')  # 指定保存的文件名和格式
